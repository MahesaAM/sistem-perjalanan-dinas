...
<div class="modal fade" id="tambah_golongan" data-backdrop="static" data-keyboard="false" tabindex="-1" role="dialog" aria-labelledby="staticBackdropLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg">
	...
	<form action="<?= base_url('Golongan/tambah_jenis') ?>" method="post">
        <div class="from-group">
			<label>Title</label>
			<input type="text" name="title" class="form-control" placeholder="Masukan title golongan" requiredd="">
		</div>
        <div class="from-group">
			<label>Deskripsi</label>
			<input type="text" name="deskripsi" class="form-control" placeholder="Masukan deskripsi golongan" requiredd="">
		</div>
      </div>
...
<div class="modal fade" id="hapus_golongan<?= $g['golongan_id'] ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
		<form action="<?= base_url('Golongan/hapus_jenis') ?>" method="post">
        <h3>Apakah Anda Yakin Ingin Menghapus <b><?= $g['golongan_deskripsi'] ?></b></h3>
      </div>
      <div class="modal-footer">
...
<div class="modal fade" id="edit_golongan<?= $g['golongan_id'] ?>" data-keyboard="false" tabindex="-1" role="dialog" aria-labelledby="staticBackdropLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      ...
      <div class="modal-body">
	<form action="<?= base_url('Golongan/edit_jenis') ?>" method="post">
		<input type="hidden" value="<?= $g['golongan_id'] ?>" name="id">
        <div class="from-group">
			<label>Title</label>
			<input type="text" name="title" class="form-control" value="<?= $g['golongan_title'] ?>" placeholder="Masukan title golongan" requiredd="">
		</div>
        <div class="from-group">
			<label>Deskripsi</label>
			<input type="text" name="deskripsi" class="form-control" value="<?= $g['golongan_deskripsi'] ?>" placeholder="Masukan deskripsi golongan" requiredd="">
		</div>
      </div>
      <div class="modal-footer">
        <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
