			...
			<div class="col-md-12">
				<div class="panel panel-default">
					<div class="panel-body">
                        ...
                        <a target="_blank" href="<?= base_url('Sppd/print_spd_peserta/'.$id_sppd.'/'.$id_peserta) ?>" style="float: right; position:relative;" class="btn btn-info"><i class="fa fa-print"></i></a>
						<div class="canvas-wrapper paper">
                            ...
                            <table style="width: 100%;margin-top:100px;">
                                <tr>
                                    <td style="text-align: center; font-weight:bold;width:50%;"><?= $p['anggota_nama'] ?></td>
                                    <td style="text-align: center; font-weight:bold;"><?= $t['pegawai_kanan'] ?></td>
                                </tr>
                            </table>
                            </div>
						</div>
                            ...
                            <table class="table table-bordered">
                                ...
                                <td>
                                    ...
                                    <td style="text-align: center;">
                                        ...
                                        <b><?= $t['text_header_bawah'] ?></b><br><br><br><br><b><?= $t['pegawai_bawah'] ?></b>
                                    </td>
                                </tr>
                                <tr>
